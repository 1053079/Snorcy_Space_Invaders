...
def main():
    ...
    level = 0
    lives = 5
    main_font = pygame.font.Font("Monocraft.otf", 35)
    lost_font = pygame.font.Font("Monocraft.otf", 95)
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("Defeat!", 1, (204, 12, 12))
    ...
    while run:
        ...
        if len(enemies) == 0:
            ...
            for i in range(wave_length):
                enemy = Enemy(random.randrange(50, WIDTH-100), random.randrange(-1500*level/3, -100), random.choice(["red", "blue", "green"]))
